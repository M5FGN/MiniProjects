/**
 * @version 1.0
 * @description Digital Stitch virtual pet which displays Stitch's Badness Level depending on pet inputs.
 * @author Mary Fagan
 */
...
/**
 * Displays values when the more button is clicked to a maximum of 10.
 */
function more() {
...
/**
 *  Displays values when the less button is clicked to a minimum of 0.
 */
function less() {
    let action_value = document.getElementById('lbl_' + action).innerHTML;
    if (action_value > 0) {
...
/**
 * Calculates Badness Level based on form inputs. 
 * Displays image relative to calculated Badness Level.
 * @todo Improvement this function by splitting it into two - calculation and display image.
 */
